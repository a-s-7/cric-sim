...
@tournament_service_bp.route('/tournaments', methods=['GET'])
def get_tournaments():
...
@tournament_service_bp.route('/tournament/<string:tournament_id>/venues', methods=['GET'])
def get_tournament_venues(tournament_id):
    return jsonify(ts.get_tournament_venues(tournament_id))

@tournament_service_bp.route('/tournament/<string:tournament_id>/groups', methods=['GET'])
def get_tournament_groups(tournament_id):
    return jsonify(ts.get_tournament_groups(tournament_id))

@tournament_service_bp.route('/tournament/<string:tournament_id>/stages', methods=['GET'])
...
@tournament_service_bp.route('/tournament/<string:tournament_id>/matches', methods=['GET'])
...
@tournament_service_bp.route('/tournament/<string:tournament_id>/standings', methods=['GET'])
